...
class CruiseMenu extends Component {
  ...
  renderLoweringPanel() {
    ...
    if(this.props.lowering.id){
      return (          
        <Panel>
          <Panel.Heading><Panel.Title>{"Lowering: " + this.props.lowering.lowering_id}</Panel.Title></Panel.Heading>
          <Panel.Body>
            ...
            <p><strong>Pilot:</strong> {this.props.lowering.lowering_pilot}</p>
            <p><strong>Observers:</strong> {this.props.lowering.lowering_observers.join(', ')}</p>
